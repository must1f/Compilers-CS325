...
loop:                                             ; preds = %body, %entry
  ...
  %fgt = fcmp ogt float %term2, %eps3
  br i1 %fgt, label %body, label %afterloop

body:                                             ; preds = %loop
  %term4 = load float, ptr %term, align 4
  %x5 = load float, ptr %x1, align 4
  %fmul = fmul float %term4, %x5
  %x6 = load float, ptr %x1, align 4
  %fmul7 = fmul float %fmul, %x6
  %n8 = load float, ptr %n, align 4
  %fdiv = fdiv float %fmul7, %n8
  %n9 = load float, ptr %n, align 4
  %fadd = fadd float %n9, 1.000000e+00
  %fdiv10 = fdiv float %fdiv, %fadd
  store float %fdiv10, ptr %term, align 4
  %cos11 = load float, ptr %cos, align 4
  %alt12 = load float, ptr %alt, align 4
  %term13 = load float, ptr %term, align 4
  %fmul14 = fmul float %alt12, %term13
  %fadd15 = fadd float %cos11, %fmul14
  store float %fadd15, ptr %cos, align 4
  %alt16 = load float, ptr %alt, align 4
  %fneg = fneg float %alt16
  store float %fneg, ptr %alt, align 4
  %n17 = load float, ptr %n, align 4
  %fadd18 = fadd float %n17, 2.000000e+00
  store float %fadd18, ptr %n, align 4
  br label %loop
