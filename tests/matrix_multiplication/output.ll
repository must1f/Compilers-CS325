...
body16:                                           ; preds = %loop12
  ...
  %arrayidx0 = getelementptr float, ptr %c_ptr, i32 %i17
  ...
  %arrayidx021 = getelementptr float, ptr %a_ptr, i32 %i19
  ...
  %arrayidx026 = getelementptr float, ptr %b_ptr, i32 %k24
  ...
  %arrayidx032 = getelementptr float, ptr %c_ptr29, i32 %i30
