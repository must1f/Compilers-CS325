...
loop:                                             ; preds = %body, %entry
  ...
  br i1 %gt, label %body, label %afterloop

body:                                             ; preds = %loop
  %number4 = load i32, ptr %number1, align 4
  %mod = srem i32 %number4, 10
  store i32 %mod, ptr %rmndr, align 4
  %rev5 = load i32, ptr %rev, align 4
  %mul = mul i32 %rev5, 10
  %rmndr6 = load i32, ptr %rmndr, align 4
  %add = add i32 %mul, %rmndr6
  store i32 %add, ptr %rev, align 4
  %number7 = load i32, ptr %number1, align 4
  %sdiv = sdiv i32 %number7, 10
  store i32 %sdiv, ptr %number1, align 4
  br label %loop
